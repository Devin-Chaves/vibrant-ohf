<template lang="html">
  <div class="investment-opportunities child">
    <div class="box-wrapper">

      <div class="box box--wide">
        <div class="copy">
          <div class="big">Reality:</div>
          <div>Fearing a post-Brexit <br> recession, some global <br> investors fled. But the <br> opposite proved true and <br> growth accelerated. Volatility <br> creates opportunity.</div>
        </div>
      </div>
      <div class="box">
        <a href="https://ad.doubleclick.net/ddm/clk/320520044;149536111;m" target="_blank">
          <div class="copy challenge fat-child">
            <span class="big"><span class="green-text">Challenge</span><br>pessimism.</span>
          </div></a>
      </div>
