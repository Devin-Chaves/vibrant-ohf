<template lang="html">
  <div class="diminishing-investments child">
    <div class="box-wrapper">

      <div class="box box--wide">
        <div class="copy">
          <div class="big">Reality:</div>
          <div>Seniors are the fastest <br> growing economic sector, <br> accounting for $7.1 trillion <br> in activity. And with global <br> trends in life expectancy, <br> this number is only <br> expected to rise.</div>
        </div>
      </div>
      <div class="box">
